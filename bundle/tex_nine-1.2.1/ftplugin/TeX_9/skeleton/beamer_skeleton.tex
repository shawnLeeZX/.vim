...
\newcommand{\titlephrase}{Title} % Presentation title
\newcommand{\name}{Shuai Li} % Presenter's name
\newcommand{\affil}{USTC} % Presenter's institution
\newcommand{\email}{lishuai918@gmail.com} % Presenter's email address
